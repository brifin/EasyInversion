...
def main():
    ...
    if not os.path.exists(f'../model/llama2_7b_embedding_weights.pt'):
        ...
        print(f'Found ../model/llama2_7b_embedding_weights.pt; (skipping)')
